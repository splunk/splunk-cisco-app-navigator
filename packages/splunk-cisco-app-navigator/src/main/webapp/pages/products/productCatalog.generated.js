...
export const PRODUCT_CATALOG = [
  {
    ...
    "vendor": "Cisco",
    "tagline": "Unified Firewall Threat Defense",
    "category": "security",
    "version": "1.0.0",
    "status": "active",
  ...
  },
  {
    ...
    "display_name": "Cisco Duo Security",
  ...
  },
  {
    ...
    "display_name": "Cisco pxGrid",
    "description": "Cisco Platform Exchange Grid (pxGrid) — context-sharing fabric that enables Cisco ISE to publish identity, device, and security-group context to ecosystem partners in real time — allowing SIEM, SOAR, and network infrastructure to consume session attributes (user, device posture, TrustSec SGT) via WebSocket-based pub/sub or REST bulk download for adaptive policy enforcement and enriched security analytics.",
  ...
  },
  {
    ...
    "vendor": "Cisco",
    "tagline": "Dynamic Malware Analysis",
    "category": "security",
    "version": "1.0.0",
    "status": "active",
    "addon": "CiscoSecurityCloud",
  ...
  },
  {
    ...
    "display_name": "Cisco Secure Email Gateway (ESA)",
    "description": "Email security gateway — anti-spam, anti-malware, DLP, encryption, and advanced phishing protection for inbound and outbound email. Formerly Cisco Email Security Appliance (ESA).",
  ...
  },
  {
    ...
    "vendor": "Cisco",
    "tagline": "Multicloud Network Security",
    "category": "security",
    "version": "1.0.0",
    "status": "active",
    "addon": "CiscoSecurityCloud",
  ...
  },
  {
    ...
    "display_name": "Cisco Catalyst Center (DNAC)",
    ...
    "addon_setup_url": "/app/TA_cisco_catalyst/add_input?app_name=dna_center_input",
    "addon_troubleshoot_url": "",
    ...
    "sc4s_label": "SC4S: Digital Network Area (DNA)",
    "sc4s_supported": true,
    "sc4s_search_head_ta": "",
    "sc4s_search_head_ta_label": "",
    "sc4s_search_head_ta_splunkbase_id": "",
  ...
  },
  {
    ...
    "display_name": "Cisco Catalyst Switches (IOS)",
    ...
    "addon_splunkbase_uid": "7538",
    "addon_docs_url": "/app/TA_cisco_catalyst/user_guide",
    "addon_setup_url": "/app/TA_cisco_catalyst/add_input?app_name=syslog_input",
    "addon_troubleshoot_url": "",
    "addon_install_url": "/manager/launcher/appsremote?order=relevance&query=Catalyst&offset=0&category=network_security&type=addon&support=cisco",
    "app_viz": "cisco-catalyst-app",
    "app_viz_label": "Cisco Enterprise Networking for Splunk Platform",
  ...
  },
  {
    ...
    "addon_splunkbase_uid": "7538",
    "addon_docs_url": "/app/TA_cisco_catalyst/user_guide",
    "addon_setup_url": "/app/TA_cisco_catalyst/add_input?app_name=ise_input",
    "addon_troubleshoot_url": "",
    "addon_install_url": "/manager/launcher/appsremote?order=relevance&query=Catalyst&offset=0&category=network_security&type=addon&support=cisco",
    "app_viz": "cisco-catalyst-app",
    "app_viz_label": "Cisco Enterprise Networking for Splunk Platform",
  ...
  },
  {
    ...
    "sc4s_supported": true,
    "sc4s_search_head_ta": "Splunk_TA_cisco_meraki",
    "sc4s_search_head_ta_label": "Cisco Meraki Add-on for Splunk",
    "sc4s_search_head_ta_splunkbase_id": "5580",
    "sc4s_sourcetypes": [
      "meraki",
      "meraki:accesspoints",
      "meraki:securityappliances",
    ...
    "netflow_config_notes": [
      "For a Meraki MX or Z-Series appliance, enable NetFlow v9 export in Meraki Dashboard under Security & SD-WAN > Traffic analytics > Add a collector.",
      "MX and Z-Series appliances export standard NetFlow v9. Meraki switches and access points do not use this exporter path, and Cisco Catalyst Enhanced NetFlow Add-on (6872) is not supported for Meraki NetFlow.",
      "Requires Stream: App for Stream (1809) on search heads; Add-on for Stream Forwarders (5238) on forwarders; Add-on for Stream Wire Data (5234) on indexers and search heads for full field normalization and extraction."
    ],
    "best_practices": [],
    "sort_order": 105,
  ...
  },
  {
    ...
    "addon_splunkbase_uid": "7538",
    "addon_docs_url": "/app/TA_cisco_catalyst/user_guide",
    "addon_setup_url": "/app/TA_cisco_catalyst/add_input?app_name=sdwan_input",
    "addon_troubleshoot_url": "",
    "addon_install_url": "/manager/launcher/appsremote?order=relevance&query=Catalyst&offset=0&category=network_security&type=addon&support=cisco",
    "app_viz": "cisco-catalyst-app",
    "app_viz_label": "Cisco Enterprise Networking for Splunk Platform",
    ...
    "sc4s_config_notes": [
      ...
      "SC4S assigns sourcetype cisco:viptela — no Splunk TA currently provides CIM field mappings for this sourcetype. Custom props.conf/transforms.conf extractions may be required for CIM compliance.",
      "The Cisco Catalyst Add-on (7538) sourcetypes (cisco:sdwan:*) are from the vManage API path and do not apply to SC4S syslog ingestion."
    ],
    "netflow_supported": true,
    ...
    "netflow_addon_docs_url": "/app/TA_cisco_catalyst/user_guide#part-2-cisco-catalyst-netflow--splunk-stream-deployment-guide",
    "netflow_setup_url": "/app/TA_cisco_catalyst/add_input?app_name=sdwan_input",
    "stream_docs_url": "https://help.splunk.com/en/splunk-cloud-platform/collect-stream-data/install-and-configure-splunk-stream/8.1/introduction/about-splunk-stream",
    "netflow_sourcetypes": [
      "stream:netflow"
    ],
    "netflow_config_notes": [
      "Cisco Catalyst Add-on for Splunk (7538) includes a guided SD-WAN NetFlow workflow for Stream HEC readiness, receiver 0, destination-index confirmation, and canary validation.",
      "NetFlow v9 and IPFIX v10 records are exported by each SD-WAN edge directly to a Splunk Stream Forwarder. Catalyst SD-WAN Manager pushes the device configuration but does not send the flow records.",
      "Match receiver 0's listener IP and UDP port with the collector in Catalyst SD-WAN Manager. The guided form suggests UDP 2055 for a new v9/HSL receiver and UDP 4739 for a new v10/IPFIX receiver.",
      "Install Splunk App for Stream (1809) on search heads, Splunk Add-on for Stream Forwarders (5238) on flow collectors, and Splunk Add-on for Stream Wire Data (5234) on indexers and search heads.",
      "For supported Catalyst SD-WAN enterprise HSL or IPFIX decoding, install Cisco Catalyst Enhanced NetFlow Add-on (6872) on Stream Forwarders. Install it on the Stream management search head only if the Cisco stream definition is not visible.",
      "The production sourcetype is stream:netflow. Use eventtype=cisco_netflow for CIM-compatible searches, and keep exactly one intended production NetFlow definition enabled."
    ],
    "best_practices": [],
    "sort_order": 110,
    "es_compatible": true,
  ...
  },
  {
    ...
    "netflow_config_notes": [
      "Configure NetFlow v9 or IPFIX export on IOS-XR routers to point at the Stream Forwarder.",
      "CRS runs IOS-XR and exports standard NetFlow — no Cisco Enhanced NetFlow Add-on (6872) is required.",
      "Requires Stream: App for Stream (1809) on search heads; Add-on for Stream Forwarders (5238) on forwarders; Add-on for Stream Wire Data (5234) on indexers and search heads for full field normalization and extraction."
    ],
    "best_practices": [],
    "sort_order": 113,
  ...
  },
  {
    ...
    "display_name": "Cisco Crosswork NSO",
  ...
  },
  {
    ...
    "display_name": "Cisco IOS-XR Platforms",
  ...
  },
  {
    ...
    "description": "Cisco Application Centric Infrastructure (ACI) — policy-driven data center automation with application profiles, micro-segmentation, and fabric-wide health monitoring.",
  ...
  },
  {
    ...
    "display_name": "Cisco Nexus Switches",
  ...
  },
  {
    ...
    "addon_splunkbase_uid": "7538",
    "addon_docs_url": "/app/TA_cisco_catalyst/user_guide",
    "addon_setup_url": "/app/TA_cisco_catalyst/add_input?app_name=cyber_vision_input",
    "addon_troubleshoot_url": "",
    "addon_install_url": "/manager/launcher/appsremote?order=relevance&query=Catalyst&offset=0&category=network_security&type=addon&support=cisco",
    "app_viz": "cisco-catalyst-app",
    "app_viz_label": "Cisco Enterprise Networking for Splunk Platform",
  ...
  },
  {
    ...
    "display_name": "Cisco TVCS",
    "description": "Cisco TelePresence Video Communication Server (TVCS) — video conferencing session control and firewall traversal platform that enables rich video collaboration across and beyond enterprise networks for organizations using Cisco TelePresence conferencing applications.",
  ...
  },
  {
    ...
    "display_name": "Cisco PSIRT",
    "description": "Cisco Product Security Incident Response Team (PSIRT) manages the receipt, investigation, and public reporting of security vulnerability information related to Cisco products and networks. The openVuln API provides machine-consumable access to Cisco security advisories. NOTE: The Splunkbase add-on for this product may be archived.",
  ...
  },
  {
    ...
    "display_name": "Cisco CMX",
    "description": "Cisco Connected Mobile Experiences (CMX) was a location analytics platform that leveraged Wi-Fi infrastructure to provide real-time location tracking, proximity analytics, and engagement insights. CMX has been retired by Cisco and superseded by Cisco Spaces.",
